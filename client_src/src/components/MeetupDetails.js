...
class MeetupDetails extends Component{
  ...
  render(){
    return (
     <div>
       <br />
       <Link className="btn grey" to="/">Atras</Link>
       <h1>{this.state.details.name}</h1>
       <ul className="collection">
        <li className="collection-item">Nombre: {this.state.details.city}</li>
        <li className="collection-item">Apellido: {this.state.details.address}</li>
        <li className="collection-item">Tipo: {this.state.details.address}</li>
        </ul>
